import { Add, Campaign, ChevronLeft, ChevronRight } from "@mui/icons-material";
...
const Dashboard = () => {
    ...
    return (
        <div data-aos="fade" className="flex p-3 gap-3">
            <div className="lg:flex hidden flex-col justify-between p-2 border min-w-[20rem] w-3/12 rounded-xl">
                <div>
                    ...
                    <div className='border rounded-t-lg p-3 mt-3'>
            ...
            <div className="flex flex-col justify-between border w-full lg:rounded-xl rounded-lg">
                <div>
                    <Header />
                    <Main />
                </div>
